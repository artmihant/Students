...
class Goblin(object):
    ...
    def __init__(self, name, lvl=1):
        ...
        В данном случае у гоблина будет имя, уровень и редкость. 
        Максимум hp и сила атаки будут вычисляться из уровня и редкости. """
        self.name = name
        self.lvl = lvl
...
# Существует особый синтаксичесйи сахар для генераторов списков
